...
export default function LoginPage() {
  ...
  const [loginType, setLoginType] = useState<"credentials" | "accessCode">("credentials")
        ...
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-8">
            <Link href="/" className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold">TestNexus</span>
            </Link>
          ...
          <div className="glass-card-strong rounded-2xl border border-white/10 p-8 shadow-2xl">
            ...
            <div className="flex gap-2 mb-6 p-1 bg-white/5 rounded-lg">
              ...
              <button
                type="button"
                onClick={() => setLoginType("accessCode")}
                className={`flex-1 py-2 px-4 rounded-lg font-medium transition-all ${
              ...
              {loginType === "credentials" ? (
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:ring-2 focus:ring-white/50 focus:border-white/30 outline-none transition-all text-white placeholder-gray-500 uppercase tracking-wider"
                  />
                  <p className="mt-2 text-sm text-gray-500">
                    Use the access code provided by your school
                  </p>
                </div>
              )}
