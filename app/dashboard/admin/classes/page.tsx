        ...
        <div className="w-full px-4 py-4 md:px-6 md:py-6 border-b border-white/10">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div>
              ...
              <p className="text-sm md:text-base text-gray-400 mt-1">Create and organize classes</p>
            </div>
            <Button
              as={Link}
          ...
          <Card className="bg-white/5 backdrop-blur-xl border border-white/10 mb-6">
            <CardHeader className="p-4 md:p-6 pb-0">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full gap-4">
                <h2 className="text-xl md:text-2xl font-bold text-white">Classes</h2>
                <Button
                  as={Link}
              ...
              {classes.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {classes.map((classItem) => (
                    <Card key={classItem.id} className="bg-white/5 backdrop-blur-xl border border-white/10 hover:border-white/20 transition-all">
                      <CardBody className="p-4 md:p-6">
                        <h3 className="font-bold text-white text-base md:text-lg mb-2">{classItem.name}</h3>
                        <p className="text-xs md:text-sm text-gray-400 mb-4">{classItem._count.students} students</p>
                        <Button
                          as={Link}
