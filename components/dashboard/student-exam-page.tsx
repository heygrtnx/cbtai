...
export function StudentExamPage({ examId }: StudentExamPageProps) {
  return (
      ...
      <div className="relative z-10">
        <div className="w-full px-4 py-4 md:px-6 md:py-6 border-b border-white/10">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div>
              <h1 className="text-2xl md:text-3xl font-black text-white">Take Exam</h1>
            </div>
            <Button
              as={Link}
        ...
        <div className="max-w-4xl mx-auto px-4 py-6 md:py-8 lg:py-12">
          <Card className="bg-white/5 backdrop-blur-xl border border-white/10">
            <CardBody className="p-4 md:p-6">
              <p className="text-gray-400">Exam interface coming soon...</p>
            </CardBody>
          </Card>
        </div>
      </div>
