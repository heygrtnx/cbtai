      ...
      <div className="relative z-10">
        <div className="w-full px-4 py-4 md:px-6 md:py-6 border-b border-white/10">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div>
              <h1 className="text-2xl md:text-3xl font-black text-white">Student Details</h1>
            </div>
            <Button
              as={Link}
            ...
            <CardBody className="p-4 md:p-6">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-white font-semibold">{student.user?.name || "N/A"}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm mb-1">Admission Number</p>
                  <p className="text-white font-semibold">{student.admissionNumber}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm mb-1">Email</p>
                  <p className="text-white font-semibold">{student.user?.email || "N/A"}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm mb-1">Phone</p>
                  <p className="text-white font-semibold">{student.user?.phone || "N/A"}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm mb-1">Class</p>
                  <p className="text-white font-semibold">{student.class?.name || "N/A"}</p>
                </div>
              </div>
            </CardBody>
          </Card>
