      ...
      <div className="relative z-10">
        <div className="w-full px-4 py-4 md:px-6 md:py-6 border-b border-white/10">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div>
              <h1 className="text-2xl md:text-3xl font-black text-white">Teacher Details</h1>
            </div>
            <Button
              as={Link}
            ...
            <CardBody className="p-4 md:p-6">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-white font-semibold">{teacher.user?.name || "N/A"}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm mb-1">Staff Number</p>
                  <p className="text-white font-semibold">{teacher.staffNumber}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm mb-1">Email</p>
                  <p className="text-white font-semibold">{teacher.user?.email || "N/A"}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm mb-1">Phone</p>
                  <p className="text-white font-semibold">{teacher.user?.phone || "N/A"}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm mb-1">Subjects</p>
                  <p className="text-white font-semibold">{teacher.subjects.join(", ") || "None"}</p>
                </div>
              </div>
            </CardBody>
          </Card>
